...
export default function CardProfile() {
  return (
    <aside className="w-profile-container md: border border-solid border-second-gray rounded-3xl overflow-hidden py-20 px-10 fixed flex flex-col items-center">
